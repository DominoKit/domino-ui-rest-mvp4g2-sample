 ...
 */
@Application(
    eventBus = DominoUiMvpRestSampleEventBus.class,
    loader = DominoUiMvpRestSampleLoader.class,
    historyOnStart = true
)
public interface DominoUiMvpRestSampleApplication extends IsApplication {
}
